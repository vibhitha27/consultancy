...
const trustPoints = [
  {
    icon: <img src="https://seekvectorlogo.net/wp-content/uploads/2018/12/mrf-madras-rubber-factory-vector-logo.png" alt="MRF Logo" className="h-16" />,
    title: 'Authorized MRF Distributor',
    description: 'We are an official distributor of MRF tyres, ensuring you get genuine products with full warranty coverage.',
  },
  {
    icon: <AlertCircle className="h-12 w-12 text-primary-500" />,
    title: 'Expert Recommendations',
    description: 'Our AI-powered system provides personalized tyre recommendations based on your specific needs and driving conditions.',
  },
  {
    icon: <TruckIcon className="h-12 w-12 text-primary-500" />,
    title: 'Free Delivery',
    description: 'Enjoy free delivery on all orders above ₹5,000 within city limits, with options for quick installation.',
  },
];
  ...
  return (
    <div className="pt-20">
      ...
      <section className="py-20 bg-white">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Why Choose Sri Jeyam Tyres?</h2>
            <p className="text-neutral-600 max-w-2xl mx-auto">
              We're committed to providing quality tyres and exceptional service to all our customers.
            </p>
          </div>
