...
const dashboardData = {
  ...
  recentOrders: [
    ...
    { id: 'ORD123454', customer: 'Vikram Patel', date: '2023-04-14', amount: 3500, status: 'Processing' },
    { id: 'ORD123453', customer: 'Anita Desai', date: '2023-04-13', amount: 6800, status: 'Shipped' },
    { id: 'ORD123452', customer: 'Suresh Menon', date: '2023-04-13', amount: 2500, status: 'Delivered' },
  ],
  popularProducts: [
